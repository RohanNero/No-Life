  ...
  factory: function (require) {
    var plugin = (() => {
      ...
      var Ce = I((M) => {
        ...
        function er(e, t) {
          return (
            Object.keys(t !== void 0 ? t : {}).forEach((r) => {
              e[r] = t[r](e);
            }),
            e
          );
      ...
      var Ze = I((A) => {
        ...
        var or = ({ isTimedOut: e, status: t }) => !e && ~~t == 0,
          ir = (e) => {
            let t = e.status;
            return (
              e.isTimedOut || or(e) || (~~(t / 100) != 2 && ~~(t / 100) != 4)
            );
          },
          cr = ({ status: e }) => ~~(e / 100) == 2,
          ur = (e, t) =>
          ...
          let {
            ...
            p = {
              ...
              read(h, S) {
                ...
                if ((O.cacheable !== void 0 ? O.cacheable : h.cacheable) !== !0)
                  return P();
                let v = {
                  request: h,
        ...
        function dr(e) {
          let t = {
            ...
            add(r) {
              ...
              return (
                t.value.indexOf(s) === -1 && (t.value = `${t.value}${s}`), t
              );
            },
          };
          return t;
        ...
        function Ye(e) {
          ...
          return Object.keys(e)
            .map((r) => pr("%s=%s", r, t(e[r]) ? JSON.stringify(e[r]) : e[r]))
            .join("&");
        }
        function $e(e, t) {
          if (
      ...
      var tt = I((w) => {
        ...
        var N = F(),
          ...
          yr = (e) => (t, r) =>
            e.transporter.write(
              { method: z.MethodEnum.Post, path: "2/abtests", data: t },
              r
            ),
          gr = (e) => (t, r) =>
            e.transporter.write(
          ...
          fr = (e) => (t, r) =>
            e.transporter.read(
              { method: z.MethodEnum.Get, path: N.encode("2/abtests/%s", t) },
              r
            ),
          br = (e) => (t) =>
            e.transporter.read(
      ...
      var jt = I((i) => {
            ...
            s = q.createTransporter(
              g(
                u(
                  {
                    hosts: [
                      { url: `${t}-dsn.algolia.net`, accept: q.CallEnum.Read },
        ...
        var Rr = (e) => (t, r) => {
            ...
            return l.createWaitablePromise(
              e.transporter.write(
                { method: m.MethodEnum.Post, path: "1/keys", data: a },
                n
              ),
              o
            );
          ...
          Mr = (e) => (t, r) => {
            ...
            return l.createWaitablePromise(
              e.transporter.write(
                { method: m.MethodEnum.Delete, path: l.encode("1/keys/%s", t) },
                r
              ),
              s
            );
          ...
          $ = (e) => (t, r) =>
            e.transporter.read(
              { method: m.MethodEnum.Get, path: l.encode("1/keys/%s", t) },
              r
            ),
          kr = (e) => (t) =>
          ...
          Ur = (e) => (t) =>
            e.transporter.read(
              { method: m.MethodEnum.Get, path: "1/clusters/mapping/top" },
              t
            ),
          Nr = (e) => (t, r) =>
            e.transporter.read(
          ...
          Br = (e) => (t) =>
            e.transporter.read(
              { method: m.MethodEnum.Get, path: "1/clusters/mapping" },
              t
            ),
          Kr = (e) => (t, r, s) => {
            let n = (a, o) =>
          ...
          Vr = (e) => (t, r) => {
            ...
            return (
              ...
              e.transporter.write(
                { method: m.MethodEnum.Delete, path: "1/clusters/mapping" },
                s
              )
            );
          },
          ...
          te = (e) => (t, r, s) => {
            ...
            return l.createWaitablePromise(d(), (b, f) =>
              Promise.all(b.taskIDs.map((p) => D(e)(p, f)))
            );
          },
          ts = (e) => (t) =>
          ...
          rs = (e) => (t) => {
            ...
            return (
              r && (n.queryParameters.forwardToReplicas = 1),
              l.createWaitablePromise(
                e.transporter.write(
                  {
                    method: m.MethodEnum.Post,
          ...
          is = (e) => (t, r) => {
            ...
            return (
              s && (a.queryParameters.forwardToReplicas = 1),
              l.createWaitablePromise(
                e.transporter.write(
                  {
                    method: m.MethodEnum.Delete,
          ...
          fs = (e) => (t, r) => {
            ...
            return l.createWaitablePromise(S, (P, x) =>
              Promise.all(p.map((v) => v.wait(x)))
            );
          },
          bs = (e) => (t, r) =>
          ...
          ye = (e) => (t, r) => {
            ...
            return (
              s && (o.queryParameters.forwardToReplicas = 1),
            ...
            send(s) {
              return new Promise((n) => {
                let a = qs.parse(s.url),
                  o =
                    a.query === null ? a.pathname : `${a.pathname}?${a.query}`,
                  d = u(
                    {
                ...
                y.on("error", (h) => {
                  ...
                  y.once("response", () => {
                    clearTimeout(f),
                      (p = b(s.responseTimeout, "Socket timeout"));
                  }),
      ...
      var se = C(require("@yarnpkg/core")),
        ...
        Wt = async (e, t) => {
          ...
          try {
            return (
              ((a = (await n.getObject(r, { attributesToRetrieve: ["types"] }))
                .types) == null
                ? void 0
      ...
      var _t = (e) => (e.scope ? `${e.scope}__${e.name}` : `${e.name}`),
        Hs = async (e, t, r, s) => {
          ...
          let b = _t(r),
            f = E.structUtils.parseRange(r.range).selector;
          ...
          let h = `${Ie.suggestUtils.Modifier.CARET}${p.major}`,
            ...
            O = E.miscUtils.mapAndFind(n.workspaces, (P) => {
              var T, V;
              let x =
                  (T = P.manifest.dependencies.get(r.identHash)) == null
                    ? void 0
                    : T.descriptorHash,
                v =
                  (V = P.manifest.devDependencies.get(r.identHash)) == null
                    ? void 0
                    : V.descriptorHash;
        ...
        _s = async (e, t, r) => {
          if (r.scope === "types") return;
          let s = _t(r),
            n = E.structUtils.makeIdent("types", s);
